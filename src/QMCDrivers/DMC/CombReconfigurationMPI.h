...
#ifndef QMCPLUSPLUS_COMB_RECONFIGURATION_WALKER_CONTROLMPI_H
#define QMCPLUSPLUS_COMB_RECONFIGURATION_WALKER_CONTROLMPI_H
 ...
 */
struct CombReconfigurationMPI: public WalkerControlBase
{
   ...
   */
  CombReconfigurationMPI(Communicate* c=0);
